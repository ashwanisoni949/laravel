    ...
    <div class="container-fluid py-3">
        <div class="container">
            <div class="bg-light py-2 px-4 mb-3">
                <h3 class="m-0 text-center">Contact Us</h3>
            </div>
            <div class="row">
                <div class="col-md-5">
                    <div class="bg-light mb-3" style="padding: 30px;">
                        <h6 class="font-weight-bold">Contact to Admin</h6>
                        <p>And then, they provide recommendations 
                            of what answers you might be looking for,
                             as well as top categories and topics </p>
                        <div class="d-flex align-items-center mb-3">
                            <i class="fa fa-2x fa-map-marker-alt text-primary mr-3"></i>
                            <div class="d-flex flex-column">
                                <h6 class="font-weight-bold">Join Group</h6>
                                <p class="m-0"><a href="" class="text-danger">click to join group</a></p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="m-0">ashwaniverma949@gmail.com</p>
                            </div>
                        </div>
                ...
                <div class="col-md-7">
                    <div class="contact-form bg-light mb-3" style="padding: 30px;">
                        <div id="success"></div>
                        <form action="{{route('user.contact.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-md-6">
                            ...
                            <div>
                                <button class="btn btn-primary font-weight-semi-bold px-4" style="height: 50px;" type="submit" id="sendMessageButton"><i class="fas fa-spinner fa-pulse text-warning"></i> Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
