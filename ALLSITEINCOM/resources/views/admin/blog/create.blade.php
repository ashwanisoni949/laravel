                                    ...
                                    <form action="{{ route('admin.blog.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_slug" id="category_id"
                                                            ...
                                                            @foreach ($category as $item)
                                                                <option
                                                                    {{ old('category_slug') == $item->id ? 'selected' : '' }}
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="start_date" id="datetimepicker"  data-date-format="DD MMMM YYYY">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="end_date" id="datetimepicker">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="ckeditor" id="summernote1" name="description">{{ old('description') }}</textarea>
                                            </div>
                                            <div class="mt-3">
