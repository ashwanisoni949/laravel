        ...
        <div class="add-client bg-white rounded">
            <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                    <div class="col-md-6">
                        <b>unmatchedColumns, ["unmatchCount" => (!empty($heading) ? collect($columns)->where('required','Yes')->whereNotIn('id', $heading)->count() : 0)])</b>
                        · <a href="javascript:void(0);"
                                onclick="skipall()">skipAll</a>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="row importBox {{ !empty($heading) ? (collect($columns)->whereIn('id', $heading[$key])->first() ? 'matched' : 'unmatched') : 'unmatched' }}"
                                    ...
                                    <div class="importOptions w-100">
                                        ...
                                        <div class="selectColumnNameBox" id="selectColumnNameBox_{{ $key }}" style="display:none;">
                                            ...
                                            <div class="col-sm-12 p-0">
                                                <div class="form-group">
                                                    <button onclick="goBack({{ $key }})" class="btn btn-info btn-sm" type="button">btnBack</button>
                                                    <button onclick="saveColumnBox({{ $key }})" class="btn btn-dark btn-sm"
                                                        type="button">btnSave</button>
                                                    <a href="javascript:void(0);" onclick="skipColumnBox({{ $key }})">skip</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <p id="columnDescriptionBoxText_{{ $key }}">
                                                    @if (!empty($heading))
                                                        ...
                                                        @else
                                                        <span class="unmatchedWarning" id="unmatchedWarning_{{$key}}">unmatchedColumn</span>
                                                        @endif
                                                    @else
                                                      <span class="unmatchedWarning" id="unmatchedWarning_{{$key}}">unmatchedColumn</span>
                                                    @endif
                                        ...
                                        <div class="row editAndSkipBox" id="editAndSkipBox_{{ $key }}">
                                            <div class="col-sm-12">
                                                <a href="javascript:void(0);" onclick="showColumnBox({{ $key }})">edit</a>&nbsp;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#process-employee-form', function() {
            const url = "{{ route('work-report.import.process') }}";
