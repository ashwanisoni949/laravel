...
class CustomFormController extends Controller
{
    ...
    {
        $custom_form = CustomForm::orderBy('created_at', 'DESC')->get();
        $custom_form_field = CustomFormField::all();
        return view('customform.index', compact('custom_form', 'custom_form_field'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('customform.edit', compact('custom_form', 'custom_form_field'));
    }
