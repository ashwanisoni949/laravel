...
class EmailTemplatesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('email-template.create',compact('email_group'));
    }
     ...
     public function list($id)
    {
        ...
        $email_group = EmailGroup::all();
        $template_list = EmailTemplates::where('group_id',$id)->get();


        return view('email-template.index', compact('template_list', 'email_group','id'));
