...
class SettingGroupKeyController extends Controller
{
    ...
    public function listing($id)
    {
        ...
        $setting_key_list = SettingGroupKey::where('group_id',$id)->get();
        $setting_group_list = SettingGroup::all();
        return view('setting-group-key.index',compact('setting_key_list','setting_group_list','id'));
    ...
    { 
        ...
        $setting_group_id = SettingGroupKey::where('group_id', $request->group_id)->first();
        $Setting_Group = SettingGroup::all();

        return response()->json(['setting_group_id'=>$setting_group_id, 'Setting_Group' => $Setting_Group]);
    }
    ...
    public function updateappsettingkey(Request $request)
    {
        ...
        $setting->update();
             ...
             return response()->json(['status'=>1, 'message'=>'setting group key update changed Successfully']);
    }
