...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('UserManage::user.index', compact('user_list', 'role_list'));
    }
    ...
    {
        $role_list = Role::all();
        return view('UserManage::user.create', compact('role_list'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('UserManage::user.edit', compact('role_list', 'user', 'role_list1'));
    }
    ...
    public function profile(){
        ...
        return view('UserManage::profile.index', compact('profiledata'));
    }
