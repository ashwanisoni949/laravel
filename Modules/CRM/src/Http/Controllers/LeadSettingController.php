...
class LeadSettingController extends Controller
{
    ...
    public function index()
    {
           ...
           $source_list = LeadSource::orderBy('created_at','DESC')->paginate(10);
           $industry_list = Industry::orderBy('created_at','DESC')->paginate(10);
           $status_list = LeadStatus::orderBy('created_at','DESC')->paginate(10);
           return view('CRM::lead-setting.index', compact('source_list','industry_list','status_list'));
    }
    ...
    { 
        ...
        $status->status = 1;
        $status->save();
        return response()->json(['status'=>1, 'success'=>'Status name added successfully']);
    }
    ...
    public function storeIndustry(Request $request)
    {
      ...
      return response()->json(['status'=>1, 'success'=>'Industry name added successfully']);
    }
    ...
    public function LeadSourceUpdate(Request $request)
    {
       ...
       return response()->json(['status'=>1, 'success'=>'Lead Source Updated Successfully']);
    }
     ...
     public function LeadStatusUpdate(Request $request)
    {
       ...
       return response()->json(['status'=>1, 'success'=>'Lead Status Updated Successfully']);
    }
    ...
    public function LeadIndustryUpdate(Request $request)
    {
       ...
       return response()->json(['status'=>1, 'success'=>'Lead Industry Updated Successfully']);
    }
