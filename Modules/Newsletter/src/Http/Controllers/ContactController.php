...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Newsletter::contact_list.index', compact('contact_list','country_name','contact_group','contact_to_group'));
    }
    ...
    public function GetContact(Request $request,$id)
    {
       ...
       $showGroupName = ContactGroup::where('id',$id)->get('group_name');
        ...
        return view('Newsletter::contact_list.get-contact-list', compact('ShowContact','showGroupName'));
    }
    ...
    public function import(){
        ...
        return view('Newsletter::contact_list.bulk-import',compact('showGroupName','country_name'));
    }
    ...
    {       
        ...
        //    return redirect()->route('contact-list.index')->with('success', 'Contact Added Successfully');
           return redirect('contact-list/'.$request->group_id)->with('success', 'Contact Added Successfully');  
    ...
    public function GetGroupId(Request $request,$id)
    {
        ...
        return view('Newsletter::contact_list.index', compact('contact_list','country_name','contact_group','contactData','contact_to_group'));
    }
}
