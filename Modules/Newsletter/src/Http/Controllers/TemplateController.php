...
class TemplateController extends Controller
{
    ...
    {  
        ...
        $template_group_list = Template::paginate(10);
        return view('Newsletter::template.index', compact('template_group_list','perPage'));
    }
    ...
    {
        // return view('Newsletter::template.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $template_group->save();
        return redirect()->route('template-group-list.index')->with('success', 'Group Added successfully');
    }
